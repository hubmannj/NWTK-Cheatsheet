...
- [Router](#router)
  - [Basic´s](#basics)
    - [Hostname](#hostname)
    - [Interface list](#interface-list)
    - [Configure more than one Interface](#configure-more-than-one-interface)
    - [Stop console logging](#stop-console-logging)
    - [DHCP-Server](#dhcp-server)
  - [VLAN](#vlan)
    - [Router-On-A-Stick](#router-on-a-stick)
    - [Seperate Links for every VLAN](#seperate-links-for-every-vlan)
  - [FHRP](#fhrp)
    - [HSRP](#hsrp)
    - [Configuration](#configuration)
  - [Dynamic Routing Protocols](#dynamic-routing-protocols)
    ...
    - [RIP](#rip)
      ...
      - [Route Poisining](#route-poisining)
      - [Administrative Distance (AD)](#administrative-distance-ad)
      - [Configuration (RIP)](#configuration-rip)
    - [OSPF](#ospf)
      - [Dijkstra-Alghorythm](#dijkstra-alghorythm)
      - [LSA´s](#lsas)
      - [LSDB](#lsdb)
...
```bash
track 1 interface <int> line-protocol
exit
int <int>
